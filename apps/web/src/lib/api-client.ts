...
export const excel = {
  ...
  downloadInspection: (year: number, month: number, params?: { companyId?: string; dateFrom?: string; dateTo?: string; status?: string; customer?: string }) =>
    api.get(`/excel/inspection/${year}/${month}`, { responseType: 'blob', params: params || {} }),
};
